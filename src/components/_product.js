                    ...
                    <div className="bg-white w-full h-2/6 md:w-[80%] md:h-full  ">
                        <div className="text-azulito p-5 md:mt-[40%]">
                            ...
                            <div className="bg-white w-[100%] flex m-0">
                                ...
                                <button onClick={() => agregado()} className="bg-azulito  hover:bg-rojitoSubidito duration-500 text-white font-semibold py-1 px-3 mx-10 my-2  md:my-4 md:px-5 md:mx-1 md:w-[50%]  rounded-full">
