    ...
    return (
        <div className="bandera  my-0 md:h-auto h-auto p-14 py-44 lg:h-auto flex content-center justify-center">
            <div class="md:flex md:space-x-9 space-y-9  lg:space-x-9 lg:space-y-0 content-center justify-center">
                <div className="shadow-2xl font-medium shadow-black rounded-xl bg-white p-10  w-auto h-auto flex items-center justify-center lg:w-2/6">
                ...
                <div className=" shadow-2xl font-medium shadow-black rounded-xl bg-white p-10  w-auto h-auto grid content-center items-center justify-center lg:w-2/6">
                    <p className="lg:text-xl">
                        Con ChurroDog{" "}
                        <a class="underline decoration-rojito font-bold">
                            {" "}
