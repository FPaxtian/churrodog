...
const About = () => {
  return (
    <div className="about">
      <div className="contenedor-general  w-auto h-[80vh] bg-white grid  lg:flex">
        <div className="información bg-white w-full h-auto lg:w-1/2">
          <h1 className=" underline  decoration-rojito font-bold text-2xl p-3 px-5 md:px-10 md:mt-0 md:text-4xl lg:text-6xl lg:mt-16 2xl:text-8xl 2xl:mt-20 2xl:pl-20 text-slate-800  ">
            ChurroDog
          </h1>
          <h2 className="p-3 px-5 lg:text-xl lg:mt-5 2xl:text-xl 2xl:mt-10 2xl:pl-20 text-slate-800">
          ...
          <h2 className="p-3 px-5 lg:text-xl  2xl:text-xl 2xl:mt-5 2xl:pl-20 text-slate-800">
